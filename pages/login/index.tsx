...
const index = (props: Props) => {
  ...
  return (
    <div className="flex items-center justify-center h-screen px-[25px] w-1/2 m-auto ">
      <form className="w-full">
        ...
        <div className="flex items-center gap-[20px] mt-[29px] justify-center">
          <Link href="google.com">
            {" "}
            <img src="/../assets/mblview/login/google.png" alt="" />
          </Link>
          <Link href="facebook.com">
            {" "}
            <img src="/../assets/mblview/login/facebook.png" alt="" />
          </Link>
          <Link href="instagram.com">
            <img src="/../assets/mblview/login/instagram.png" alt="" />
          </Link>
        </div>
        <div className="flex items-center justify-center mt-[57px]">
          <p className="text-[13px] text-[#666666] leading-[10.72px] font-normal">
            Need an account ?{" "}
            <span className="text-[13px] text-[#BB243F] leading-[10.72px] font-bold underline decoration-[#BB243F]/[0.3]">
              SIGNUP
            </span>
          </p>
        </div>
