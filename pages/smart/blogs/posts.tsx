        ...
        <div className='bg-[#F9F9F9]'>
            ...
            <div className=' relative mb-[60px]'>
                ...
                <div className='absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] transform text-[#F9F9F9] flex items-center justify-center flex-col'>
                    ...
                    <p className='text-[18px] leading-[27px] font-normal text-[#F9F9F9] tracking-[0.02em] professional_title'>Home  <span className='mx-[10px]'>&gt;</span> Blog<span className='mx-[10px]'>&gt;</span> Posts</p>
                </div>
            </div>
                        ...
                        <div className='grid grid-cols-1 gap-[42px]  '>
                            <Link href="">
                                <div className='bg-white rounded-[5px] pt-[39px] px-[35px] pb-[22px]'>
                                    ...
                                    <p className='text-[#505056] text-[16px] leading-[25.6px] font-normal font-Roboto tracking-[0.01em] max-w-[731px] mt-[23px] mb-[14px]'>Lorem i ipsum dolor sit amet, consectetur adipisic ipsum dolor sit amet, consectetur adipisic ipsum dolor sit amet, consectetur adipisic ipsum dolor sit amet, consectetur adipisic ipsum dolor sit amet, consectetur adipisicpsum dolor sit amet, consectetur adipisicing elit. Impedit eveniet reprehenderit voluptas delectus reiciendis pariatur, totam id quae tempore fugiat tenetur asperiores saepe velit nisi voluptates molestiae quia ....</p>
                                    <p className='text-[#505056] text-[16px] leading-[25.6px] font-normal font-Roboto tracking-[0.01em] max-w-[731px] mt-[23px] mb-[14px]'>Lorem i ipsum dolor sit sic ipsum dolor sit amet, consectetur adipisic ipsum dolor sit amet, consectetur adipisicpsum dolor sit amet, consectetur adipisicing elit. Impedit eveniet reprehenderit voluptas delectus reiciendis pariatur, totam id quae tempore fugiat tenetur asperiores saepe velit nisi voluptates molestiae quia ....</p>
                                    <h2 className='text-[#232323] text-[18px] mt-[20px] font-medium leading-[28.8px] tracking-[0.01em] font-Roboto'>Some Separate Secondary Heading.</h2>
                                    <p className='text-[#505056] text-[16px] leading-[25.6px] font-normal font-Roboto tracking-[0.01em] max-w-[731px] mt-[23px] mb-[14px]'>Lorem i ipsum dolor sit amet, consectetur adipisic ipsum dolor sit amet, consectetur adipisic ipsum dolor sit amet, consectetur adipisic ipsum dolor sit amet, consectetur adipisic ipsum dolor sit amet, consectetur adipisicpsum dolor sit amet, consectetur adipisicing elit. Impedit eveniet reprehenderit voluptas delectus reiciendis pariatur, totam id quae tempore fugiat tenetur asperiores saepe velit nisi voluptates molestiae quia ....</p>
                                    <p className='text-[#505056] text-[16px] leading-[25.6px] font-normal font-Roboto tracking-[0.01em] max-w-[731px] mt-[23px] mb-[14px]'>Lorem i ipsum dolor sit sic ipsum dolor sit amet, consectetur adipisic ipsum dolor sit amet, consectetur adipisicpsum dolor sit amet, consectetur adipisicing elit. Impedit eveniet reprehenderit voluptas delectus reiciendis pariatur, totam id quae tempore fugiat tenetur asperiores saepe velit nisi voluptates molestiae quia ....</p>
                                    <h2 className='text-[#232323] text-[20px] leading-[23.44px] font-medium tracking-[0.02em] mt-[22px]'>Related Tags:</h2>
                                    <div className='flex items-center gap-[9px] mt-[22px]'>
                                        <div className='bg-[#2591B21A] rounded-[39px]'>
                                            <p className='text-[#2591B2] text-[12px] leading-[14.06px] font-medium font-Roboto tracking-[0.02em] py-[5px] px-[13px]'>Manual</p>
                                        </div>
                                        <div className='bg-[#2591B21A] rounded-[39px]'>
                                            <p className='text-[#2591B2] text-[12px] leading-[14.06px] font-medium font-Roboto tracking-[0.02em] py-[5px] px-[13px]'>LED TV</p>
                                        </div>
                                        <div className='bg-[#2591B21A] rounded-[39px]'>
                                            <p className='text-[#2591B2] text-[12px] leading-[14.06px] font-medium font-Roboto tracking-[0.02em] py-[5px] px-[13px]'>Machine Repair</p>
                                        </div>
                                        <div className='bg-[#2591B21A] rounded-[39px]'>
                                            <p className='text-[#2591B2] text-[12px] leading-[14.06px] font-medium font-Roboto tracking-[0.02em] py-[5px] px-[13px]'>DIY</p>
                                        </div>
                                    </div>
