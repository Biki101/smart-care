        ...
        <>
            ...
            <div>
                <div className='serivedetail relative mb-[37px]'>
                    <img src="/../assets/servicedetails/banner.jpg" className='w-full h-[332px] object-cover' alt="" />

                    <div className='absolute top-[57px]   text-white product_detail '>
                        <p className='text-[14px] leading-[17.01px] font-normal tracking-[0.02em]'>appliance Repairs &gt; Microwave Ovens</p>
                        <h1 className='text-[38px] leading-[46.17px] font-bold tracking-[0.02em] max-w-[804px] mt-[10px]'>Best Microwave Oven Repair in Kathmandu
                            SMART CARE <span className='bg-[#1F3F98] rounded-[60px] text-[29.75px] leading-[44.63px] font-bold tracking-[0.02em] text-[#F9F9F9] px-[20px]'>4.5</span></h1>
                        <div className='mt-[8.97px]' >
                            <p className='text-[16px] leading-[33.04px] font-medium tracking-[0.02em]'>100 Days Warranty on Repair</p>
                            <p className='text-[16px] leading-[33.04px] font-medium tracking-[0.02em]'>Doorstep Repair within 3 Hours</p>
                            <p className='text-[16px] leading-[33.04px] font-medium tracking-[0.02em]'>Experienced, Reliable, and Fully Trained Technician</p>
                            <p className='text-[16px] leading-[33.04px] font-medium tracking-[0.02em]'>100% Genuine Spare Parts with Genuine Rate</p>
                        </div>
                ...
                <div className='container mx-auto '>
                    <div className='flex gap-[45px]'>
                        <div className='basis-[70%]  '>
                            <h1 className='text-[23px] text-[#505056] leading-[32.89px] font-bold tracking-[0.01em]'> Microwave Oven Repair and Services - Smart Care</h1>
                            <p className='mt-[30px] text-[16px] text-[#000000d8] '>In the present era, almost every house has a microwave. Microwave Oven not only provides a different way of cooking, but it also brings out people's inner chefs. It uses microwave radiation to cause atomic movement in water, fat, sugar molecules, etc. to cook the food. That’s why it is faster than normal cooking. But Servicing and repairing a microwave oven might be a headache, especially if you work on a busy schedule. Finding microwave repair experts is indeed difficult and time-consuming. We don't want you or your everyday routines to suffer because of a faulty microwave.</p>
                            <p className='text-[16px] text-[#000000d8] mt-[20px]'>Thus, we at Smart Care Service are here to provide microwave repair and services that you can order online at any time and from anywhere.</p>
                            <div className='mt-[20px]'>
                                <h2 className='text-[16px] text-[#505056] leading-[32.89px] font-bold tracking-[0.01em]'> Types Of Microwave Oven We Repair</h2>
                                <p className='text-[16px] text-[#000000d8]'>We offer Microwave Oven Repair and Services for the following types:</p>
                                <ul>
                                    <li className='text-[16px] text-[#000000d8]'> - Grill Microwave Oven</li>
                                    <li className='text-[16px] text-[#000000d8]'> - Convection Microwave Oven</li>
                                </ul>
                            </div>
                            <div className='pt-[20px]'>
                                <h2 className='text-[#2591B2] text-[23px] leading-[22.88px] tracking-[0.01em] font-bold'>Our Services</h2>
                                <p className='mt-[15px] text-[15px] text-[#505056]'> Our Microwave Oven Repair and Services Include:</p>
                                <div>
                                    <h2 className='text-[16px] font-semibold text-[#505056] mt-[20px]'>Dead/No On</h2>
                                    <p className='text-[16px] text-[#000000d8]'> If your microwave oven does not turn on, it could be due to a connection fault, which you can resolve by simply disconnecting and replugging. If this does not fix your issue then something serious has happened as the fuse has blown. You can reach out to Smartcare Repair and Services for assistance. </p>
                                </div>
                                <div>
                                    <h2 className='text-[16px] font-semibold text-[#505056] mt-[20px]'>Keys not Working:</h2>
                                    <p className='text-[16px] text-[#000000d8]'>The unresponsiveness of the keys(button) can be due to a variety of reasons ranging from loose panel connection to damaged switch membrane and control board. If you observe these kinds of problems, you can contact us at Smart Care Repair and Services to solve the problem for you.</p>
                                </div>
                                <div>
                                    <h2 className='text-[16px] font-semibold text-[#505056] mt-[20px]'>Visible sparks inside Microwave oven:</h2>
                                    <p className='text-[16px] text-[#000000d8]'> If you can see visible sparks inside the microwave oven during its operation, you have to cut its power off immediately. The cause of visible sparks can be due to waveguide cover damage, burned diode out, or other issues. These kinds of issues should be handled by only professionals. Smartcare Repair And Services have experienced technicians to solve such problems for you.</p>
                                </div>
                                <div>
                                    <h2 className='text-[16px] font-semibold text-[#505056] mt-[20px]'>Less/No Heating </h2>
                                    <p className='text-[16px] text-[#000000d8]'>The microwave oven seems operating but is not producing enough heat to warm up food. This might be because of damage to the heating component. You can call Smartcare Repair and Services to fix such issues.</p>
                                </div>
                                <div>
                                    <h2 className='text-[16px] font-semibold text-[#505056] mt-[20px]'>Switching on/off by itself:</h2>
                                    <p className='text-[16px] text-[#000000d8]'> Sometimes microwave oven operates independently by switching the on/off button by itself. This is caused by various reasons like a defect in the diode (Triac), improper functioning of the control panel, or if the switch gets stuck. You can give us a call at Smartcare Repair and services to fix your problem for you.</p>
                                </div>
                                <div>
                                    <h2 className='text-[16px] font-semibold text-[#505056] mt-[20px]'>Other repairs:</h2>
                                    <p className='text-[16px] text-[#000000d8]'>If you are observing other problems that are not mentioned above like, microwave door not opening, microwave oven suddenly stops while heating, or any other issue, you can contact Smartcare Repair and Services to solve it for you.</p>
                                </div>
                                <div>
                                    <h2 className='text-[16px] font-semibold text-[#505056] mt-[20px]'>Popular Brands Microwave Oven We Repair </h2>
                        ...
                        <div className='basis-[30%] '>
                            <div className='selectProduct_category  pt-[39px]'>
                                <h1 className='text-white text-[24px] leading-[34.32px] font-bold tracking-[0.01em] text-center '>Select Product Category</h1>
                                <div className='w-[283px] h-[54px] bg-white mt-[50px] ml-[31px] flex items-center justify-between pr-[15.42px] pl-[19.96px]'>
                                    <p className='text-[#232323] text-[18px] leading-[25.74px] font-normal'>MWO Convection</p>
                                    <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1.13672 1L6.57903 7L1.13672 13" stroke="#121212" strokeWidth="2" strokeLinecap="round" />
                                    </svg>
                                </div>
                                <div className='w-[283px] h-[54px] bg-white mt-[18px] ml-[31px] flex justify-between items-center pl-[19.96px] pr-[15.42px]'>
                                    <p className='text-[#232323] text-[18px] leading-[25.74px] font-normal'>MWO Grill</p>
                                    <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1.13672 1L6.57903 7L1.13672 13" stroke="#121212" strokeWidth="2" strokeLinecap="round" />
                                    </svg>
                                </div>
            ...
            <div className='bg-[#FBFCFE] pt-[38px] pb-[52px] mt-[30px]'>
                <div className='container mx-auto pl-[10px] sm:pl-[0px]'>
                    <div className='flex items-center justify-between pr-[10px]'>
                        <h1 className='text-[#2591B2] md:text-[20px] text-[17px] leading-[38.88px] font-bold'>Popular Services Near you</h1>
                    ...
                    <Slider {...settings} className="mt-[28.5px] ">
                        <div >
                            ...
                            <p className='text-center text-[#000000] text-[10px] md:text-[15px] leading-[21.09px] font-normal'>Microwave Oven</p>
                        </div>
                        <div>
                            <div className='bg-white border border-[#EDEDED] rounded-[5px] mb-[27px] flex items-center justify-center flex-col w-[106px] h-[100px] md:w-[162px] md:h-[106px] 2xl:w-[93%]'>
                                <img src="/../assets/deepfridge.png" alt='' className='w-[122px] h-[72px] object-cover' />
                            </div>
                            <p className='text-center text-[#000000] text-[10px] md:text-[15px] leading-[21.09px] font-normal' >Deep Fridge-VISI Cooler</p>
                        </div>
                        <div>
                            <div className='bg-white border border-[#EDEDED] rounded-[5px] mb-[27px] flex items-center justify-center flex-col w-[106px] h-[100px] md:w-[162px] md:h-[106px] 2xl:w-[93%]'>
                                <img src="/../assets/geyser.png" alt='' className='w-[122px] h-[72px] object-cover' />
                            </div>
                            <p className='text-center text-[#000000] text-[10px] md:text-[15px] leading-[21.09px] font-normal'>Geyser</p>
                        </div>
                        <div>
                            <div className='bg-white border border-[#EDEDED] rounded-[5px] mb-[27px] flex items-center justify-center flex-col w-[106px] h-[100px] md:w-[162px] md:h-[106px] 2xl:w-[93%]'>
                                <img src="/../assets/refrigerator.png" alt='' className='w-[122px] h-[72px] object-cover' />
                            </div>
                            <p className='text-center text-[#000000] text-[10px] md:text-[15px] leading-[21.09px] font-normal'>Refrigerator</p>
                        </div>
                        <div>
                            <div className='bg-white border border-[#EDEDED] rounded-[5px] mb-[27px] flex items-center justify-center flex-col w-[106px] h-[100px] md:w-[162px] md:h-[106px] 2xl:w-[93%]'>
                                <img src="/../assets/chimney.png" alt='' className='w-[122px] h-[72px] object-cover' />
                            </div>
                            <p className='text-center text-[#000000] text-[10px] md:text-[15px] leading-[21.09px] font-normal'>Chimney</p>
                        </div>
                        <div>
                            <div className='bg-white border border-[#EDEDED] rounded-[5px] mb-[27px] flex items-center justify-center flex-col w-[106px] h-[100px] md:w-[162px] md:h-[106px] 2xl:w-[93%]' >
                                <img src="/../assets/chimney.png" alt='' className='w-[122px] h-[72px] object-cover' />
                        ...
                        <div>
                            ...
                            <p className='text-center text-[#000000] text-[10px] md:text-[15px] leading-[21.09px] font-normal'>Home Heater</p>
                        </div>
                        <div>
                            <div className='bg-white border border-[#EDEDED] rounded-[5px] mb-[27px] flex items-center justify-center flex-col w-[106px] h-[100px] md:w-[162px] md:h-[106px] 2xl:w-[93%]' >
                                <img src="/../assets/vaccumeCleaner.png" alt='' className='w-[122px] h-[72px] object-cover' />
                            </div>
                            <p className='text-center text-[#000000] text-[10px] md:text-[15px] leading-[21.09px] font-normal'>Vacume Cleaner</p>
                        </div>
            ...
            <div className='flex w-full'>
                ...
                <div className='basis-[75%] flex justify-center items-center pl-[101px] pr-[100px] py-[50px] shadow-lg'>
                    <div>
                        <h2 className='text-[#2591B2] text-[23px] leading-[32.89px] font-semibold tracking-[0.01em] text-center'>Why Choose Smart Care</h2>
                        <p className='text-[#505056] text-[15px] leading-[24px] font-normal tracking-[0.01em] mt-[17px] text-center'>Smart Care Service Group recognizes the problems that a broken microwave oven can create, as well as the need of getting it back in running condition. That's why, we provide quick, reliable, and long-lasting Microwave oven Repair and Services.</p>
                        <div className='bg-[#EDEDED] w-full h-[1px] my-[32px]'>
                        ...
                        <div className='space-y-[36px]'>
                            ...
                            <div className='flex items-center gap-[31px]'>
                                <div><svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M39.4431 37.7879C39.0833 38.1028 39.0563 38.4895 39.3441 38.8313L39.587 39.1191H41.0351C42.5552 39.1101 42.6721 39.0832 42.879 38.6964C43.0499 38.3816 43.0049 38.1297 42.7261 37.8509L42.4652 37.5901H41.0621C39.7489 37.5901 39.6589 37.5991 39.4431 37.7879Z" fill="#2591B2" />
                                    <path d="M28.6899 40.882C28.3301 41.1788 28.3032 41.6286 28.636 41.9524C28.8518 42.1683 28.8878 42.1772 30.282 42.1772C31.5952 42.1772 31.7391 42.1593 31.955 41.9884C32.1259 41.8534 32.1888 41.7185 32.1888 41.5027C32.1888 40.7561 31.955 40.6482 30.264 40.6482C28.9957 40.6482 28.9598 40.6572 28.6899 40.882Z" fill="#2591B2" />
                                    <path d="M34.1525 40.7831C33.7388 41.0169 33.6758 41.6016 34.0176 41.9704C34.1975 42.1683 34.2604 42.1772 35.6726 42.1772C37.1207 42.1772 37.1477 42.1772 37.3636 41.9524C37.6514 41.6735 37.6514 41.2778 37.3726 40.945L37.1567 40.6931L35.7715 40.6752C34.6742 40.6572 34.3414 40.6752 34.1525 40.7831Z" fill="#2591B2" />
                                    <path d="M39.5668 40.7651C39.0901 41.008 39.0091 41.6286 39.4049 41.9974C39.5848 42.1593 39.7197 42.1772 41.0689 42.1772C42.4091 42.1772 42.553 42.1593 42.7149 41.9974C43.1017 41.6106 43.0207 41.008 42.535 40.7651C42.2292 40.6122 39.8726 40.6122 39.5668 40.7651Z" fill="#2591B2" />
                                    <path d="M15.6283 20.1315C15.4483 20.2754 15.4034 20.4104 15.3674 20.9231C15.3224 21.5257 15.3224 21.5347 15.0525 21.5617C14.027 21.6696 12.5876 22.2902 11.715 23.0098C11.0943 23.5135 10.4286 24.4489 10.1947 25.1325C9.2861 27.8399 11.3192 30.6372 14.6927 31.3208L15.3224 31.4467L15.3494 34.8736C15.3674 37.644 15.3494 38.3096 15.2504 38.3096C14.9626 38.3096 14.063 38.0217 13.5502 37.7609C12.8305 37.4011 12.0209 36.6186 11.778 36.0699C11.679 35.8361 11.5531 35.3863 11.5081 35.0625C11.4002 34.3969 11.2022 34.1721 10.7165 34.1721C10.0328 34.1721 9.80786 34.7927 10.1047 35.908C10.3206 36.7445 10.6715 37.3202 11.4002 38.0487C11.9579 38.6064 12.2458 38.8133 12.9385 39.1461C13.7481 39.5328 14.7377 39.8387 15.1695 39.8387C15.3494 39.8387 15.3674 39.8836 15.3674 40.4053C15.3674 40.855 15.4034 41.0169 15.5473 41.1698C15.7902 41.4307 16.114 41.5026 16.4109 41.3497C16.7438 41.1968 16.8967 40.882 16.8967 40.3334V39.8836L17.5984 39.7307C19.6045 39.317 21.3137 38.0217 21.9434 36.4477C22.1233 36.007 22.1593 35.7641 22.1593 34.8826V33.8393L21.7815 33.0747C21.1698 31.8425 20.0003 30.8621 18.5339 30.3494C18.1741 30.2234 17.6703 30.0885 17.4095 30.0526L16.9417 29.9896L16.9147 26.5447C16.8877 22.5691 16.7707 22.9378 17.9492 23.3336C19.5415 23.8733 20.4951 24.8807 20.684 26.2478C20.7829 26.9944 21.0618 27.2912 21.5656 27.2103C22.0964 27.1293 22.2313 26.8775 22.1863 26.059C22.0874 24.395 20.711 22.7669 18.7409 21.9844C18.399 21.8495 17.8413 21.6876 17.5174 21.6336L16.9147 21.5437L16.8787 20.968C16.8427 20.4733 16.8067 20.3564 16.5908 20.1765C16.294 19.9157 15.9161 19.8977 15.6283 20.1315ZM15.3674 26.4817C15.3674 30.3764 15.4933 30.0076 14.3148 29.6298C13.4962 29.378 12.6056 28.7933 12.1648 28.2356C10.7524 26.4457 11.724 24.1881 14.2879 23.3156C14.6117 23.2077 14.9805 23.1087 15.1245 23.1087H15.3674V26.4817ZM17.9132 31.7525C19.1007 32.1483 20.0453 32.9218 20.4501 33.8303C20.666 34.316 20.693 34.4599 20.657 35.0625C20.63 35.4673 20.549 35.872 20.4501 36.0609C19.8923 37.1493 18.6869 37.9678 17.1936 38.2646L16.8967 38.3276V34.9456V31.5636H17.1216C17.2475 31.5636 17.6074 31.6446 17.9132 31.7525Z" fill="#2591B2" />
                                    <path d="M1.92877 23.3067C1.62291 23.5855 0.939213 25.3754 0.561383 26.8415C0.120581 28.5955 -0.0503427 30.2685 0.012629 32.1933C0.192548 37.4372 1.93777 41.1069 5.34724 43.3736C6.93053 44.4259 8.67574 45.1185 10.8168 45.5503C12.661 45.919 13.6505 46 16.2234 46C18.8232 45.991 19.9027 45.8921 21.7469 45.4693C22.5115 45.2984 22.7274 45.2085 22.8984 45.0196C23.1862 44.6868 23.1592 44.381 22.8354 44.0482C22.5205 43.7424 22.6375 43.7334 20.7663 44.0931C17.5278 44.7048 13.3087 44.6238 10.34 43.8773C6.84956 43.0048 4.3217 41.1159 2.91833 38.3276C1.39801 35.2965 1.09214 30.4484 2.18965 26.6707C2.3156 26.2299 2.60347 25.4204 2.82837 24.8807C3.08925 24.2331 3.2062 23.8284 3.17021 23.7024C3.07126 23.3606 2.76539 23.1088 2.45054 23.1088C2.27062 23.1088 2.06371 23.1897 1.92877 23.3067Z" fill="#2591B2" />
                                </svg></div>
                                <div className="pt-[20px]">
                                    <h2 className='text-[#2591B2] text-[16px] leading-[22.88px] font-bold tracking-[0.01em]'>Budget-Friendly</h2>
                                    <p className='text-[#505056] text-[15px] leading-[24px] font-normal tracking-[0.01em] mt-[6px]'>The Technician can be booked for the same or less than any other local technician near you.
                                        We understand what is important to you and we believe in shaping the right solution based on your needs. </p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                <div className='container mx-auto pt-[101px] pb-[111px]'>
                    <h1 className='text-[#2591B2] text-[23px] leading-[32.89px] font-semibold tracking-[0.01em] text-center'>FAQ On Washing Machine Repair And Services</h1>
                    <div className='pl-[274px] pr-[270px] mt-[40px]'>
                        <div className='bg-[#2591B21A] py-[12px] pl-[16px]'>
                            <p className='text-[#505056] text-[16px] leading-[22.88px] font-normal tracking-[0.01em]'>What brands of microwave ovens do you repair?</p>
                        </div>
                        <p className='text-[#505056] text-[16px] leading-[25.6px] font-normal tracking-[0.01em] mt-[12px]'>Smart Care Technicians can work with any brand of microwave. However, LG, Samsung, Whirlpool, IFB, ELECTROLUX, Skyworth, and Hisense are the popular brands that Smart Care normally deals with.</p>
                    </div>
                    <div className='pl-[274px] pr-[270px] mt-[55px]'>
                        <div className='bg-[#2591B21A] py-[12px] pl-[16px]'>
                            <p className='text-[#505056] text-[16px] leading-[22.88px] font-normal tracking-[0.01em]'>Should I trust Smart Care Microwave oven Repair and Services technician?</p>
                        </div>
                        <p className='text-[#505056] text-[16px] leading-[25.6px] font-normal tracking-[0.01em] mt-[12px]'>All Microwave Repair and Services on Smart Care are experienced and background checked. Our main concern is our client’s safety. So, You do not have to worry about it.</p>
                    </div>
                    <div className='pl-[274px] pr-[270px] mt-[55px]'>
                        <div className='bg-[#2591B21A] py-[12px] pl-[16px]'>
                            <p className='text-[#505056] text-[16px] leading-[22.88px] font-normal tracking-[0.01em]'>What are the services Smart Care provides in Microwave repair?</p>
                        </div>
                        <p className='text-[#505056] text-[16px] leading-[25.6px] font-normal tracking-[0.01em] mt-[12px]'>Microwave Repair and Services Provided by Smart Care include diagnosis of the fault in the microwave, repair it, and replacing the genuine parts if needed.</p>
                    </div>
                    <div className='pl-[274px] pr-[270px] mt-[55px]'>
                        <div className='bg-[#2591B21A] py-[12px] pl-[16px]'>
                            <p className='text-[#505056] text-[16px] leading-[22.88px] font-normal tracking-[0.01em]'>How much will it cost me to get my microwave Oven repaired?</p>
                        </div>
                        <p className='text-[#505056] text-[16px] leading-[25.6px] font-normal tracking-[0.01em] mt-[12px]'>The cost of the Microwave Repair and Services cannot be fixed before a diagnosis of the fault in the microwave. After analyzing the problem, adding service charge, and spare parts cost if needed to be replaced, we can decide the cost.</p>
                    </div>
                    <div className='pl-[274px] pr-[270px] mt-[55px]'>
                        <div className='bg-[#2591B21A] py-[12px] pl-[16px]'>
                            <p className='text-[#505056] text-[16px] leading-[22.88px] font-normal tracking-[0.01em]'>Why should I keep my microwave clean?</p>
                        </div>
                        <p className='text-[#505056] text-[16px] leading-[25.6px] font-normal tracking-[0.01em] mt-[12px]'>The remaining food or grease on the bottom of your microwave, as well as moisture from the steam in the air, can combine with filth and oil to produce a bacteria-friendly environment.</p>
                    </div>
                </div>
            </div>
            <BottomNavbar />
