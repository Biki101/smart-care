        ...
        <div className='bg-[#FBFCFE] pt-[43px] md:mt-[38px] pb-[44px]'>
            <div className='container mx-auto pl-[10px] sm:pl-[0px]'>
                <div className='flex items-center justify-between pr-[10px]'>
                    <h1 className='text-[#232323] text-[17px] md:text-[20px] leading-[38.88px] font-bold'>Carpenter Services</h1>
                    {/* <p className='sm:hidden text-[#BB243F]/[0.5] text-[12px] leading-[15px] font-normal cursor-pointer'>View All</p> */}
                </div>
                <Slider {...settings} className="mt-[28.5px] ">
                    <div className='cursor-pointer '>
                        <div className='bg-white border border-[#EDEDED] transform hover:scale-[105%] transition-all duration-200 ease-in-out rounded-[5px] mb-[27px] flex items-center justify-center flex-col w-[106px] h-[100px] md:w-[162px] md:h-[106px] 2xl:w-[93%]'>
                            <img src="/../assets/furnituremaking.png" alt="" className='w-[122px] h-[76px] object-cover' />
                        </div>
                        <p className='text-center text-[#000000] text-[12px] md:text-[15px] leading-[21.09px] font-normal'>New Furniture Making</p>
                    </div>
                    <div className='cursor-pointer '>
                        <div className='bg-white border border-[#EDEDED] transform hover:scale-[105%] transition-all duration-200 ease-in-out rounded-[5px] mb-[27px] flex items-center justify-center flex-col w-[106px] h-[100px] md:w-[162px] md:h-[106px] 2xl:w-[93%]'>
                            <img src="/../assets/repair.png" alt="" className='w-[122px] h-[76px] object-cover' />
                        </div>
                        <p className='text-center text-[#000000] text-[12px] md:text-[15px] leading-[21.09px] font-normal' >Repairs & Fixing</p>
                    </div>
                    <div className='cursor-pointer '>
                        <div className='bg-white border border-[#EDEDED] transform hover:scale-[105%] transition-all duration-200 ease-in-out rounded-[5px] mb-[27px] flex items-center justify-center flex-col w-[106px] h-[100px] md:w-[162px] md:h-[106px] 2xl:w-[93%]'>
                            <img src="/../assets/repair.png" alt="" className='w-[122px] h-[76px] object-cover' />
                        </div>
                        <p className='text-[#000000] text-[12px] md:text-[15px] leading-[21.09px] font-normal text-center'> Other wood work</p>
                    </div>
                    <div>
