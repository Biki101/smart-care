...
function SampleNextArrow({ onClick }: any) {
  return (
    <div
      onClick={onClick}
      className="absolute top-[-38%] right-[2.5%] carousel_btn  items-center justify-center hidden sm:flex cursor-pointer"
    >
      <svg
        width="11.67"
        height="21.67"
...
function SamplePrevArrow({ onClick }: any) {
  return (
    <div
      onClick={onClick}
      className="carousel_btn  items-center justify-center absolute z-20 top-[-38%] hidden sm:flex xl:right-[7%] md:right-[10%] cursor-pointer"
    >
      <svg
        width="11.67"
        height="21.67"
